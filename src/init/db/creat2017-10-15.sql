...
CREATE TABLE `member` (
  ...
  `creat_id` int(11) DEFAULT NULL COMMENT '创建者',
  PRIMARY KEY (`member_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='员工表：编号，工号，姓名，性别，手机，身份证，QQ，微信账号，管理分组';

/*Data for the table `member` */

insert  into `member`(`member_id`,`number`,`NAME`,`sex`,`phone`,`card`,`qq`,`wexin`,`groups`,`qqnc`,`address`,`remark`,`TIME`,`user_name`,`password`,`OPEN`,`creat_id`) values 
(1,1,'admin','0',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2017-10-15 21:48:21','admin','123','2',NULL);
